  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p>
        ...
        evidence of your agreement and acceptance that these terms govern your and app digital pty
        ltd&apos;s rights and obligations to each other.
      </p>
      <h6>LIMITATION OF LIABILITY</h6>
      <p>
        It is an essential precondition to you using our website that you agree and accept that app
        digital pty ltd is not legally responsible for any loss or damage you might suffer related
